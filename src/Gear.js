var Gear = function(s, outerRadius, teeth, speed){
	this.s = s;
...
Gear.prototype.draw = function(c){
	...
	*/
	var sectionArc = Math.TAU / this.teeth;
	c.beginPath();
	for(var i = 0; i < this.teeth; i++){
		...
		// Figure it out for yourself. It's actually pretty simple.
	}
	c.closePath();
	c.fill();
	c.stroke();
...
Gear.prototype.update = function(field){
